...
<?php
	makeProfiles(array(
		...
		array(
			'image' => 'bill.jpg',
			'bio' => 'Bill Robertson (Instructor Assistant). Bill is a regular coach for the beginning foil class. He competes in foil and épée. Bill is an amazing singer and has performed at previous Metro Tacoma Fencing Club functions. He is a member of the board.'
		),
		array(
			'image' => 'keyon.jpg',
		...
		array(
			'image' => 'benjamin.jpg',
			'quesadilla' => 'benjaminwithrednose.jpg',
			'burrito' => 'horn.wav',
			'bio' => "Benjamin Lee (Instructor Assistant, Assistant Moniteur). Benjamin has been fencing since 2008. He was one of only eight Y10 men’s foil fencers nationally to hold a classification in the 2011-2012 season. He was one of seven 12 year olds to compete in the Junior Olympics National Championships in 2/15/2014 for Cadet (U17) men’s foil. His top national rankings by age group include Senior (open) men's foil 24th (12/11/2017), Junior (U20) men's foil 30th, and Cadet (U16) men’s foil 15th. He represented the United States in the Cadet World Cup at Bratislava, Slovakia in January, 2018 and placed 52nd out of 169 foil fencers from 23 countries. Benjamin has a classification of A2019 in foil and C2018 in épée. He is a rated referee with a 10 in foil and 10 in épée (2016). Benjamin assists with the beginning foil class. He attends Charles Wright Academy. Benjamin earned his certificate from the US Fencing Coaches Association as an Assistant Moniteur in 2016. His coach is Kwangsuk Chung."
		),
		array(
			'image' => 'brian.jpg',
			'bio' => "Brian Li (Instructor Assistant, Assistant Moniteur). Brian has been fencing since 2014. Brian earned the Regional Gold patch for Y12 épée for the 2015-16 season and the Regional Silver patch for Y14 épée in the 2016-17 season. His best finish has been 2nd place for division 3 men’s épée at the April North American Cup (NAC) at Salt Lake City in 2019. Brian has a classification of C2019 in épée. He is a rated referee in all three weapons with a rating of 9 in foil, épée, and saber (2016). Brian assists with the beginning épée class. He earned his certificate from the US Fencing Coaches Association as an Assistant Moniteur in 2018. Brian attends the Science and Math Institute high school here in Tacoma. Brian also enjoys playing the tenor saxophone, learning jazz, and glass blowing. His coach is Dana Sanford."
		),
		array(
			'image' => 'andrew.jpg',
